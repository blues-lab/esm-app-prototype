        ...
        >
          <CheckBox
            ...
            onPress={() => {
              this.props.callback(
                "Acquaintance",
                !this.state.acquaintanceSelected
              );
              this.setState({
                acquaintanceSelected: !this.state.acquaintanceSelected
              });
            }}
          />
          <CheckBox
            ...
            onPress={() => {
              ...
              this.setState({
                colleaguesSelected: !this.state.colleaguesSelected
              });
            }}
          />
        </View>
        ...
        >
          <CheckBox
            ...
            onPress={() => {
              ...
              this.setState({
                roommatesSelected: !this.state.roommatesSelected
              });
            }}
          />
          <CheckBox
