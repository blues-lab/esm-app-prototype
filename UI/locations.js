...
export default class Locations extends React.Component {
  ...
  handleSelectionChange(index) {
    ...
    if (_name != "Other") {
      ...
      this.props.locationSelectionHandler(
        this.state.otherLocationName,
        _selected
      );
    }
  }
  ...
  unselectOther() {
    ...
    _locationNames[_locationNames.length - 1].renderStyle =
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.locationNames[0].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.locationNames[1].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.locationNames[2].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.locationNames[3].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.locationNames[4].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.locationNames[5].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.locationNames[6].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.locationNames[7].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
