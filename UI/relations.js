...
export default class Relations extends React.Component {
  ...
  handleSelectionChange(index) {
    ...
    if (_name != "Other") {
      ...
      this.props.relationSelectionHandler(
  ...
  unselectOther() {
    ...
    _relationNames[_relationNames.length - 1].renderStyle =
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.relationNames[0].selected
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.relationNames[1].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.relationNames[2].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.relationNames[3].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.relationNames[4].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.relationNames[5].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.relationNames[6].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
          ...
          >
            <View style={styles.rowView}>
              <Image
                ...
                source={
                  this.state.relationNames[7].selected
                    ? require("../res/checked.png")
                    : require("../res/unchecked.png")
                }
              />
